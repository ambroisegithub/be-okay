        ...
        <View style={styles.formInputField}>
          ...
          <View style={styles.inputFieldsContainer}>
            <View style={styles.row}>
              <View
                style={[
                  ...
                  styles.halfWidth,
                  errors.full_name ? styles.errorBorder:null,
                ]}
              >
                <Entypo
                  name="user"
              ...
              <View
                style={[
                  styles.inputFieldContainer,
                  styles.halfWidth,
                  errors.username ? styles.errorBorder:null,
                ]}
              >
                <Entypo
                  name="user"
            ...
            <View style={styles.row}>
              <View
                style={[
                  styles.inputFieldContainer,
                  styles.halfWidth,
                  errors.identity_number ?  styles.errorBorder: null,
                ]}
              >
              ...
              <View
                style={[
                  styles.inputFieldContainer,
                  styles.halfWidth,
                  errors.gender ? styles.errorBorder: null,
                ]}
              >
                <MaterialCommunityIcons
            ...
            <View style={styles.row}>
              <View
                style={[
                  styles.inputFieldContainer,
                  styles.halfWidth,
                  errors.date_of_birth ? styles.errorBorder:null,
                ]}
              >
                <MaterialCommunityIcons
                  name="calendar"
              ...
              <View
                style={[
                  styles.inputFieldContainer,
                  styles.halfWidth,
                  errors.marital_status ?  styles.errorBorder:null,
                ]}
              >
                <MaterialCommunityIcons
                  name="heart"
            ...
            <View
              style={[
                styles.inputFieldContainer,
                errors.location ? styles.errorBorder:null,
              ]}
            >
              <MaterialCommunityIcons
                name="map-marker"
