...
const ErrorModal = ({ visible, onClose, errorMessage }:ErrorModelProps) => (
...
const LoginPage = () => {
  ...
  const navigateToSignup = () => {
    router.push("/screen/Patient/PatientNormalSignUp");

  };

  const PasswordEmailForget = () => {
    router.push("/screen/Patient/PasswordEmailForget");
  };
