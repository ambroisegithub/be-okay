...
const DoctorSetScheduleAppointment = () => {
  ...
  const [startingDate, setStartingDate] = useState<DateData | null>(null);
  const [endingDate, setEndingDate] = useState<DateData | null>(null);
  ...
  const handleTimeSelection = (selectedHour:number, selectedMinute:number) => {
  ...
  const formatDateTime = (day: Day, time: string): string => {
