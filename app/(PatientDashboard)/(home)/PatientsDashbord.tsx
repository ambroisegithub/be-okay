...
const router = useRouter();
  ...
  const handlePress = async (type: string) => {
    ...
    router.push("/(PatientDashboard)/(home)/ChatBoxConsultationBodyImagemapping");
    } catch (error) {
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View>
          ...
          <View style={styles.patientDataContainer}>
            ...
            <Pressable onPress={() => router.push("/(PatientDashboard)/(home)/HomeCare")}>
              <View style={styles.patientDataResultContainer}>
                ...
                <View style={styles.appointmentScreen}>
                  ...
                  <View>
                    ...
                    <Pressable style={styles.joinText} onPress={()=>{
                      router.push("/(PatientDashboard)/(home)/ConsultationTypeResult")
                    }}>
