...
const ConsultationOptions = ({ onOptionSelected }) => {
  ...
  const consultationOptionss = [
    ...
    {
      shortName: "Chronic",
      fullName: "Chronic illness",
      image: require("@/assets/Consultation/awareness.png"),
    },
    {
      shortName: "Intestine",
      fullName: "Intestine Medicine",
  ...
  return (
    <View>
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          console.log(consultationOptionss);
